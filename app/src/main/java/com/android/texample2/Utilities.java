...
public class Utilities {
	 ...
	 *
	 * @param vertexShaderHandle  the handle of the vertex shader the program will use
	 * @param fragmentShaderHandle  the handle of the fragment shader the program will use
	 * @param variables  an array of {@link AttribVariable} instances
